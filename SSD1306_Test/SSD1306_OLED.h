...
#define SSD1306_ADDRESS 0x78 // or 0x7A
...
#define OLED_CMD_SET_CONTRAST			0x81	// follow with 0x7F (half brightness)
...
#define OLED_CMD_SET_SEGMENT_REMAP		0xA1    // for pins bottom configuration, Use A0
#define OLED_CMD_SET_MUX_RATIO			0xA8	// follow with 0x3F = 64 MUX
#define OLED_CMD_SET_COM_SCAN_MODE		0xC8    // for pins bottom configuration, use C0	
